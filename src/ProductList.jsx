...
function ProductList({ onHomeClick }) {
  ...
  //loops through the cart items and mark them as true
  useEffect(() => {
    const updatedAddedToCart = {};
    cart.forEach(item => {
      updatedAddedToCart[item.name] = true; // Mark as added if it exists in cart
    });
  ...
  //create another variable cartItemCount; total items in the cart
          ...
          {plantsArray.map((categories, index) => (
            <div key={index}>
              ...
              <div className="product-list">
                {categories.plants.map((plant, index) => (
